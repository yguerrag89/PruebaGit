...
5. En Windows V0.10, entra en **Exportación WMS** e importa el resultado de la PDA V0.10.
...
V0.10 acepta resultados v3 y los v2 de V0.9. Los resultados v1 se admiten solo para auditoría, sin habilitar el WMS. V0.9 Windows no puede leer el nuevo resultado v3: usar las dos aplicaciones V0.10 juntas.
...
- caja en `EN_DEFINITIVA` y tarima final verificada; en v3, toda su mercancía debe haber salido de la TR activa;
